...
export const OrderMessage = () => {
    ...
    return <div>
        <div className={classes.messageOrder}>
          ...
          <Typography className={classes.code}>Tu código de pedido es: {orderData}</Typography>  
        </div>
        <div className={classes.container}>
            <Link>
            <Button className={classes.button} color="primary" variant="contained" onClick={goToIndex}>Volver a comprar</Button>
            </Link>
        </div>
    </div>
}